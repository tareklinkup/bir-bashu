                        ...
                        <div class="container">
                            ...
                            <div class="row" style="border-bottom:1px solid #ccc;margin-bottom:5px;padding-bottom:6px;">
                                ...
                                <div class="col-xs-7 text-right">
                                    <span style="text-decoration:overline;">Authorized by</span><br>
                                    
                                </div>
                                <div class="row">
                                    <div class="col-xs-12">
                                       <p style="text-align:center"> Warranty void:
                                        “ Sticker removed item, Burned Case, Physically Damaged and without Cash memo ”</p>
                                    </div>
                                </div>
                            </div>
